...
-(id)initWithFrame:(CGRect)arg1 {
    ...
    self.slcTranslateItem = [[UIMenuItem alloc] initWithTitle:@"翻译" action:@selector(slcTranslate:)];
    self.slcSearchItem = [[UIMenuItem alloc] initWithTitle:@"搜索" action:@selector(slcSearch:)];
